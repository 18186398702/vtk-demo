...
import vtkAbstractImageMapper from '@kitware/vtk.js/Rendering/Core/AbstractImageMapper.js';
import { intersectWithLineForPointPicking, intersectWithLineForCellPicking } from '@kitware/vtk.js/Rendering/Core/AbstractImageMapper/helper.js';
import { E as clampValue, S as multiply3x3_vect3, H as createUninitializedBounds, T as getSparseOrthogonalMatrix } from '@kitware/vtk.js/Common/Core/Math/index.js';
import CoincidentTopologyHelper from '@kitware/vtk.js/Rendering/Core/Mapper/CoincidentTopologyHelper.js';
